  ...
  return (
    <header className="title-hero">
      <div className="title-hero-media" aria-hidden="true">
        <Image className="title-hero-image title-hero-image-desktop" src={desktopImage} alt="" fill priority={priority} sizes="100vw" />
        <Image className="title-hero-image title-hero-image-mobile" src={mobileImage} alt="" fill priority={priority} sizes="100vw" />
      </div>
